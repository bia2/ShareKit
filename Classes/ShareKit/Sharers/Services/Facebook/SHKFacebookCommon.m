...
NSString *const kSHKFacebookAPIUserInfoURL = @"https://graph.facebook.com/v2.5/me";
NSString *const kSHKFacebookAPIFeedURL = @"https://graph.facebook.com/v2.5/me/feed";
NSString *const kSHKFacebookAPIPhotosURL = @"https://graph.facebook.com/v2.5/me/photos";
NSString *const kSHKFacebookAPIVideosURL = @"https://graph.facebook.com/v2.5/me/videos";
